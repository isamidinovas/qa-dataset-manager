...
const Index = () => {
  ...
  const handleFileSelect = (file: DialogueFile) => {
    ...
    setIsMobileSidebarOpen(false); // Закрываем сайдбар на мобильном после выбора
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="md:hidden bg-white border-b px-4 py-3 flex items-center justify-between">
        ...
        <div className="w-8"></div> {/* Spacer для выравнивания */}
      </div>
      ...
      <div className="flex h-[calc(100vh-60px)] md:h-[calc(100vh-120px)]">
            ...
            <Card className="h-full flex items-center justify-center">
              <CardContent className="text-center py-12">
                <div className="text-gray-400 mb-4">
                  <svg className="mx-auto h-12 md:h-16 w-12 md:w-16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                  </svg>
                </div>
                <h3 className="text-base md:text-lg font-medium text-gray-700 mb-2">Выберите диалог</h3>
                <p className="text-sm md:text-base text-gray-500 px-4">
                  <span className="md:hidden">Нажмите на меню, чтобы выбрать файл</span>
                  <span className="hidden md:inline">Кликните на файл в сайдбаре, чтобы просмотреть диалоги в таблице</span>
                </p>
              </CardContent>
            </Card>
          )}
